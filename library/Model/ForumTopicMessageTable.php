 ...
 *
 */
class Model_ForumTopicMessageTable implements \Priyx\InjectionAwareInterface
{
    protected $di;
    ...
    public function rm(Model_ForumTopicMessage $model)
    {
        ...
        if (count($messages) == 1) {
            throw new \Priyx_Exception('This is a last message in topic. Remove topic in order to remove this message.');
        }
