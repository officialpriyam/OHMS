...
class Priyx_Period
{
    ...
    {
        if(strlen($code) != 2) {
            throw new \Priyx_Exception("Invalid period code. Period definition must be 2 chars length");
        }
        ...
        if(!array_key_exists($unit, $units)) {
            throw new \Priyx_Exception("Period Error. Unit :unit is not defined", array(':unit'=>$unit));
        }
        ...
        if($qty < $units[$unit][0] || $qty > $units[$unit][1]) {
            ...
            throw new \Priyx_Exception("Invalid period quantity :qty for unit :unit. Allowed range is from :from to :to", $d);
        }
    ...
    public function getTitle()
    {
        switch ($this->unit) {
            ...
            case self::UNIT_YEAR:
                ...
                break;
            default:
                throw new \Priyx_Exception('Unit not defined');
        }
    ...
    public function getMonths()
    {
        ...
        switch ($this->unit) {
            ...
            case self::UNIT_YEAR:
                ...
                break;
            default:
                throw new \Priyx_Exception('Can not determine months amount from unit');
        }
