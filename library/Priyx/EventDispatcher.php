...
class Priyx_EventDispatcher
{
     ...
     *
     * @param Priyx_Event $event A Priyx_Event instance
     *
     * @return Priyx_Event The Priyx_Event instance
     */
    public function notify(Priyx_Event $event)
    {
     ...
     * @return Priyx_Event The Priyx_Event instance
     */
    public function notifyUntil(Priyx_Event $event)
    {
        foreach ($this->getListeners($event->getName()) as $listener) {
     ...
     * @return Priyx_Event The Priyx_Event instance
     */
    public function filter(Priyx_Event $event, $value)
    {
        foreach ($this->getListeners($event->getName()) as $listener) {
