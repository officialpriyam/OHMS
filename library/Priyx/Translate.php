...
class Priyx_Translate implements \Priyx\InjectionAwareInterface
{
    /**
     * @var \Priyx_Di
     */
    ...
    public function setup()
    {
        ...
        if(!function_exists('gettext')) {
            require_once PS_PATH_LIBRARY . '/php-gettext/gettext.inc';
            T_setlocale(LC_MESSAGES, $locale.'.'.$codeset);
            T_setlocale(LC_TIME, $locale.'.'.$codeset);
            T_bindtextdomain($this->domain, PS_PATH_LANGS);
            ...
            bindtextdomain($this->domain, PS_PATH_LANGS);
