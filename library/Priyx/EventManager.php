...
class Priyx_EventManager implements \Priyx\InjectionAwareInterface
{
    protected $di;
    ...
    public function fire($data)
    {
        ...
        $e = new Priyx_Event($subject, $event, $params);
        $e->setDi($this->di);
        $disp = new Priyx_EventDispatcher();
    ...
    /**
     * @param Priyx_EventDispatcher $disp
     * @param string              $event
     */
