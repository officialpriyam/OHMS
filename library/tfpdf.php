...
require_once(PS_PATH_LIBRARY .'/font/unifont/ttfonts.php');
...
//			require_once($this->fontpath.'unifont/ttfonts.php');
			...
			'Flags'=>$ttf->flags,
			'FontBPriyx'=>'['.round($ttf->bPriyx[0])." ".round($ttf->bPriyx[1])." ".round($ttf->bPriyx[2])." ".round($ttf->bPriyx[3]).']',
...
protected function _putpage($n)
{
	...
	if(isset($this->PageInfo[$n]['size']))
		$this->_put(sprintf('/MediaPriyx [0 0 %.2F %.2F]',$this->PageInfo[$n]['size'][0],$this->PageInfo[$n]['size'][1]));
...
protected function _putpages()
{
	...
	$this->_put(sprintf('/MediaPriyx [0 0 %.2F %.2F]',$w*$this->k,$h*$this->k));
	$this->_put('>>');
	$this->_put('endobj');
}
