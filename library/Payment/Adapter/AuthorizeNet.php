...
class Payment_Adapter_AuthorizeNet extends Payment_AdapterAbstract
{
    ...
    public static function getConfig()
    {
        return array(
            ...
            'description'     =>  'To setup Authorize.net merchant account in OHMS you need to go to <i>Account &gt; Settinggs &gt; MD5-Hash</i> and enter your own secret hash values. To receive instant payment notifications, copy "IPN callback URL" to Authorize.net "Account->Silent Post URL"',
            'form'  => array(
