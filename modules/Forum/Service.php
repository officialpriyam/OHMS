...
class Service implements InjectionAwareInterface
{
    ...
    public static function onAfterClientCreateForumTopic(\Priyx_Event $event)
    {
        $params = $event->getParameters();
        $id = $params['id'];
    }

    public static function onAfterAdminRepliedInForum(\Priyx_Event $event)
    {
        $di = $event->getDi();
        $api = $di['api_admin'];
        $params = $event->getParameters();
    ...
    public static function onAfterClientRepliedInForum(\Priyx_Event $event)
    {
        $di = $event->getDi();
        $api = $di['api_admin'];
        $params = $event->getParameters();
