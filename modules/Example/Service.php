...
class Service
{
    ...
    public function install()
    {
        ...
        // throw new \Priyx_Exception("Throw exception to terminate module installation process with a message", array(), 123);
        return true;
    }
    ...
    {
        // throw new \Priyx_Exception("Throw exception to terminate module uninstallation process with a message", array(), 124);
        return true;
    }

    /**
     * Method to update module. When you release new version to
     * extensions.OHMS.org then this method will be called
    ...
    {
        // throw new \Priyx_Exception("Throw exception to terminate module update process with a message", array(), 125);
        return true;
    }
    ...
    /**
     * Example event hook. Any module can hook to any OHMS event and perform actions.
     *
     ...
     * @throws \Priyx_Exception
     */
    public static function onEventClientLoginFailed(\Priyx_Event $event)
    {
        ...
        // Use RedBean ORM in any place of OHMS where API call is not enough
        ...
        if ($meta->meta_value > 30) {
            throw new \Priyx_Exception('You have failed to login too many times. Contact support.');
        }
    }
     ...
     */
    public static function onAfterClientCalledExampleModule(\Priyx_Event $event)
    {
