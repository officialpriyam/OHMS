...
namespace Priyx\Mod\Example\Api;
...
class Guest extends \Api_Abstract
{
    ...
    {
        // $this->di['tools'] returns tools from /library/Priyx/Tools.php
        ...
        $readme = $this->di['tools']->file_get_contents(PS_PATH_MODS.'/Example/README.md');
