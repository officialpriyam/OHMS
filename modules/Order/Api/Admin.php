...
class Admin extends \Api_Abstract
{
    ...
    public function unsuspend($data)
    {
        ...
        if (\Model_ClientOrder::STATUS_SUSPENDED != $order->status) {
            throw new \Priyx_Exception('Only suspended orders can be unsuspended');
        }
    ...
    public function uncancel($data)
    {
        ...
        if (\Model_ClientOrder::STATUS_CANCELED != $order->status) {
            throw new \Priyx_Exception('Only canceled orders can be uncanceled');
        }
    ...
    public function update_config($data)
    {
        ...
        if (!isset($data['config']) || !is_array($data['config'])) {
            throw new \Priyx_Exception('Order config not passed');
        }
