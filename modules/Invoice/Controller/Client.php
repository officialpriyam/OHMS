...
class Client implements \Priyx\InjectionAwareInterface
{
    ...
    public function get_invoices(\Priyx_App $app)
    {
    ...
    public function get_invoice(\Priyx_App $app, $hash)
    {
    ...
    public function get_invoice_print(\Priyx_App $app, $hash)
    {
        $api = $this->di['api_guest'];
        $data = [
            'hash' => $hash,
    ...
    public function get_thankyoupage(\Priyx_App $app, $hash)
    {
        $api = $this->di['api_guest'];
        $data = [
            'hash' => $hash,
    ...
    public function get_banklink(\Priyx_App $app, $hash, $id)
    {
        $api = $this->di['api_guest'];
        $data = [
