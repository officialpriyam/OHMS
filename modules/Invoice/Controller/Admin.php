...
namespace Priyx\Mod\Invoice\Controller;
...
class Admin implements \Priyx\InjectionAwareInterface
{
    ...
    public function get_taxes(\Priyx_App $app)
    {
    ...
    public function get_tax(\Priyx_App $app, $id)
    {
    ...
    public function get_invoice(\Priyx_App $app, $id)
    {
        $api = $this->di['api_admin'];
    ...
    public function get_transaction(\Priyx_App $app, $id)
    {
        $api = $this->di['api_admin'];
    ...
    public function get_transactions(\Priyx_App $app)
    {
        $this->di['is_admin_logged'];
    ...
    public function get_subscriptions(\Priyx_App $app)
    {
        $this->di['is_admin_logged'];
    ...
    public function get_subscription(\Priyx_App $app, $id)
    {
        $api = $this->di['api_admin'];
    ...
    public function get_gateways(\Priyx_App $app)
    {
        $this->di['is_admin_logged'];
    ...
    public function get_gateway(\Priyx_App $app, $id)
    {
        $api = $this->di['api_admin'];
    ...
    public function get_pdf(\Priyx_App $app, $hash)
    {
