...
namespace Priyx\Mod\Massmailer\Api;
    ...
    public function update($data)
    {
        ...
        if (isset($data['from_name'])) {
            if (empty($data['from_name'])) {
                throw new \Priyx_Exception('Message from name can not be empty');
            }
...
{% endapply %}
    ...
    public function send_test($data)
    {
        ...
        if (empty($model->content)) {
            throw new \Priyx_Exception('Add some content before sending message');
        }
