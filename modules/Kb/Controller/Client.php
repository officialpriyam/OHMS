...
namespace Priyx\Mod\Kb\Controller;
...
class Client implements \Priyx\InjectionAwareInterface
{
    ...
    public function get_kb(\Priyx_App $app)
    {
        return $app->render('mod_kb_index');
    }

    public function get_kb_category(\Priyx_App $app, $category)
    {
    ...
    public function get_kb_article(\Priyx_App $app, $category, $slug)
    {
        $api = $this->di['api_guest'];
        $data = ['slug' => $slug];
