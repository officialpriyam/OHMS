...
class Guest extends \Api_Abstract
{
    ...
    public function article_get($data)
    {
        ...
        if (!$model instanceof \Model_KbArticle) {
            throw new \Priyx_Exception('Article item not found');
        }
    ...
    {
        if (!isset($data['id']) && !isset($data['slug'])) {
            throw new \Priyx_Exception('Category ID or slug is missing');
        }
        ...
        if (!$model instanceof \Model_KbArticleCategory) {
            throw new \Priyx_Exception('Knowledge base category not found');
        }
