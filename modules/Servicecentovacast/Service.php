...
namespace Priyx\Mod\Servicecentovacast;
...
class Service implements \Priyx\InjectionAwareInterface
{
    ...
    {
        if (!is_object($model)) {
            throw new \Priyx_Exception('Could not suspend order. Service was not created', null, 7456);
        }
    ...
    {
        if (!is_object($model)) {
            throw new \Priyx_Exception('Could not unsuspend order. Service was not created', null, 7456);
        }
