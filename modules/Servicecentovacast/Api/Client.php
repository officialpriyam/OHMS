...
namespace Priyx\Mod\Servicecentovacast\Api;
...
class Client extends \Api_Abstract
{
    private function _getService($data)
    {
        ...
        if (!$order) {
            throw new \Priyx_Exception('Centova Cast order not found');
        }
        ...
        if (!$s) {
            throw new \Priyx_Exception('Order :id is not activated', [':id' => $order->id]);
        }
