...
class Guest extends \Api_Abstract
{
    ...
    public function apply_promo($data)
    {
        ...
        if (!$promo instanceof \Model_Promo) {
            throw new \Priyx_Exception('Promo code is expired or does not exist');
        }

        if (!$this->getService()->isPromoAvailableForClientGroup($promo)) {
            throw new \Priyx_Exception('Promo can not be applied to your account');
        }
