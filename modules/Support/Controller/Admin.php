...
class Admin implements \Priyx\InjectionAwareInterface
{
    ...
    public function get_ticket(\Priyx_App $app, $id, $messageid = '')
    {
    ...
    public function get_public_tickets(\Priyx_App $app)
    {
        $this->di['is_admin_logged'];
    ...
    public function get_public_ticket(\Priyx_App $app, $id)
    {
        $api = $this->di['api_admin'];
    ...
    public function get_helpdesk(\Priyx_App $app, $id)
    {
        $api = $this->di['api_admin'];
    ...
    public function get_helpdesks(\Priyx_App $app)
    {
        $this->di['is_admin_logged'];
    ...
    public function get_canned_list(\Priyx_App $app)
    {
        $this->di['is_admin_logged'];
    ...
    public function get_canned(\Priyx_App $app, $id)
    {
        $api = $this->di['api_admin'];
    ...
    public function get_canned_cat(\Priyx_App $app, $id)
    {
        $api = $this->di['api_admin'];
