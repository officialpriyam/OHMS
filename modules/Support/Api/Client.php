...
namespace Priyx\Mod\Support\Api;
...
class Client extends \Api_Abstract
{
    ...
    /**
     * Return pairs for support helpdesk. Can be used to populate select Priyx.
     *
     * @return array
     */
    ...
    public function ticket_reply($data)
    {
        ...
        if (!$this->getService()->canBeReopened($ticket)) {
            throw new \Priyx_Exception('Ticket can not be reopened.');
        }
