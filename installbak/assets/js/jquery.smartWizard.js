...
function SmartWizard(target, options) {
    ...
    this.contentWidth = 0;
    this.msgPriyx = $('<div class="msgPriyx"><div class="content"></div><a href="#" class="close">X</a></div>');
    ...
    var _init = function($this) {
        ...
        elmActionBar.append($this.msgPriyx);
        $('.close',$this.msgPriyx).click(function() {
            $this.msgPriyx.fadeOut("normal");
            return false;
        });
    ...
    SmartWizard.prototype.showMessage = function (msg) {
        $('.content', this.msgPriyx).html(msg);
        this.msgPriyx.show();
    }
