...
return [
    ...
    /**
     * Full URL where OHMS is installed with trailing slash.
     */
    'url' => 'http://localhost/',
    ...
    'db' => [
        ...
        /**
         * The name of the database for OHMS.
         */
        'name' => getenv('DB_NAME') ?: 'OHMS',
    ...
    'api' => [
        // All requests made to the API must have referrer request header with the same URL as the OHMS installation
